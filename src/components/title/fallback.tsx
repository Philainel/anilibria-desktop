export default function TitleFallback({ short }: { short: boolean }) {
	return <section className='flex animate-pulse'>
		<div className={`block bg-brand-semidark aspect-[2/3] rounded-md ${short ? 'w-[210px] h-[240px]' : 'w-[256px] h-[384px]'}`} />
		<div className='bg-transparent text-brand-semidark p-8 flex flex-col gap-6 justify-stretch font-lines'>
			...
			<div className="flex flex-row">
				<div className={`flex ${short ? 'flex-row' : 'flex-col'} w-2/5`}>
					<div>
